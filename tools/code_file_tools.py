...
def save_code_to_desktop(query_or_code, filename=None):
    ...
    if filename:
        ...
        query_lower = str(query_or_code).lower()
    ...
    try:
        with open(file_path, "w", encoding="utf-8") as f:
            f.write(code)
        return f"I have saved the code file directly to your Desktop at {file_path}, Boss!"
